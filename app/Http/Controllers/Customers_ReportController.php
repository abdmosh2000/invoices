...
class Customers_ReportController extends Controller
{
    public function index(){
        ...
        return view('reports.reports_customer',compact('section'));
...
// في حالة البحث بدون التاريخ
        ...
        if ($request->Section && $request->product && $request->start_at =='' && $request->end_at=='') {
            ...
            $section = sections::all();
            return view('reports.reports_customer',compact('section'))->withDetails($invoices);
        ...
        // في حالة البحث بتاريخ
            ...
            $section = sections::all();
            return view('reports.customers_report',compact('section'))->withDetails($invoices);
