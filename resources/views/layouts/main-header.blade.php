								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<a href="{{route('mark.Read')}}" style="padding-right: 162px"><span class="badge badge-pill badge-warning mr-auto my-auto float-left">تمييز كمقروء</span></a>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="notifications_count"> لديك {{auth()->user()->unreadNotifications->count()}}من الرسائل الغير مقروءه </p>
									</div>
									<div class="main-notification-list Notification-scroll" id="unreadNotifications">

                                        @foreach(auth()->user()->unreadNotifications as $notifications )
										<a class="d-flex p-3 border-bottom" href="{{route('InvoicesDetails.edit',$notifications->data['id'])}}" data-notif-id="{{$notifications->id}}">
											<div class="notifyimg bg-pink">
												<i class="la la-file-alt text-white"></i>
											</div>
											<div class="mr-3">
												<h5 class="notification-label mb-1">{{$notifications->data['title']}}{{$notifications->data['user']}}</h5>
